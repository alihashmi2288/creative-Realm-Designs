...
export default function Navbar() {
  ...
  return (
    <header className={`fixed top-0 w-full border-b border-white/5 transition-colors duration-300 ${isOpen ? "bg-black z-[1000]" : "bg-black/40 backdrop-blur-3xl z-[100]"}`}>
      <nav className="max-w-7xl mx-auto px-8 h-24 flex justify-between items-center relative z-[1000]">
        <Link href="/" className="text-2xl font-black tracking-tighter text-white uppercase font-display z-[1000]">
        ...
        <div className="flex items-center gap-6 z-[1000]">
          ...
          <button 
            ...
            className="md:hidden text-white p-2 focus:outline-none z-[1000]"
